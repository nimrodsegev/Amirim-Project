...
the same as the target. It labelled $62.9\%$ valid alternates, $17.5\%$
partially correct and $19.7\%$ unrelated (Figure~\ref{fig:conf}, right).
...
confidence is $0.878$ on successful completions and $0.447$ on failures --- a
usable signal in its own right. Split by probe outcome at L25
