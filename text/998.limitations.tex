...
adjudication in \S\ref{sec:falsepos} shows that exact matching rejects many
plausible alternatives within one probe-selected subset; it does not determine
the net bias in the overall recovery rates, since it examines neither a
representative sample of failures nor any successes. It also rests on a single
judge with no human validation and no inter-annotator
