...
than a single-token prediction. \textbf{Landmarks} ($127$) are drawn from a
curated list of well-known buildings and sites, and \textbf{film titles} ($185$)
are the multi-word entries of the IMDb Top 250.
