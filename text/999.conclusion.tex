...
the extremes far more than independent per-context variation would produce ---
and it is legible from the
...
--- but a policy that simply drafts a fixed number of tokens at every step was
faster still, at $1.72\times$, while diverging from the autoregressive output
...
that the open question is not whether anticipation exists --- this paper says it
does --- but whether reading it out adaptively buys enough over drafting blindly
to pay for itself.
