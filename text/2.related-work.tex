...
generalise poorly across datasets. Our probe is the same object aimed at a
different target (not whether an answer will be true but whether a phrase will
be completed), and shows a comparable pattern, including the limited
cross-category transfer in Appendix~\ref{app:details}. In a similar spirit,
...
measurable quality loss: the same object as our probe, aimed at a decoding
decision rather than an analysis question. All of these methods assume useful
anticipation exists; we measure it directly, for one well-defined class of
continuations, and characterise when it is reliable. We implement no decoding
